...
const AdminPage: React.FC = () => {
  ...
  const fetchProject = async () => {
    try {
      const res = await axios.get("https://novasysweb.onrender.com/projectEn");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post("https://novasysweb.onrender.com/projectEn", formData, {
  ...
  const deleteProject = async (id: number) => {
    ...
    try {
      await axios.delete(`https://novasysweb.onrender.com/projectEn/${id}`);
      alert("Устгагдлаа");
          ...
          {ProjectList.map((Project) => (
            ...
            >
              <div className="flex gap-4">
                {Project.image_url && (
                  <img
                    src={`https://novasysweb.onrender.com/uploadsEn/project/${Project.image_url}`}
                    alt={Project.title}
